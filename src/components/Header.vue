<template>
    <header class="header" :class="{sticky: $route.path === '/' || $route.path.includes('/projects/')}">
        <div class="container">
            ...
            <nav class="nav right">
                <a class="nav__link" href="/#projects">Works</a>
                <!-- <a class="nav__link" href="/#about">About me</a> -->
                <!-- <g-link class="nav__link" to="/journal">Journal</g-link> -->
                <a class="nav__link" href="mailto:rilton.art@gmail.com">Contact me!</a>
            </nav>
        </div>
    </header>
</template>
...
.header.sticky {
    ...
    left: 0;
    width: 100%;
    background: linear-gradient(to bottom, #072446 0%, #07244600 100%);
}
.header > .container {
    display: flex;
    align-items: center;
